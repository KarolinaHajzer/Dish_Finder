...
public class ThirdActivityVegan extends AppCompatActivity {
    Button recipe_but;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items={"tofu","apple","arugula","asparagus","avocado","banana","bean","beetroot","berries","broccoli","cabbage","carrot","cauliflower","chickpeas","corn","cucumber","eggplant","garlic","grape","kale","leek","lentil","mango"};
        ...
        recipe_but.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    InputStream is = assetManager.open("vegan_recipes.txt");
                ...
                Intent myIntent = new Intent(ThirdActivityVegan.this, FourthActivity.class);
                myIntent.putExtra("Files_to_send",selectedItems);
                ThirdActivityVegan.bundle.putString("all_recipes_vegan",string_to_send.toString());
