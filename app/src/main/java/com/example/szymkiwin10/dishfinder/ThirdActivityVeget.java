...
public class ThirdActivityVeget extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items={"tofu","eggs","milk","butter","apple","arugula","asparagus","avocado","banana","bean","beetroot","berries","broccoli","cabbage","carrot","cauliflower","chickpeas","corn","cucumber","eggplant","garlic","grape","kale","leek","lentil","mango"};
